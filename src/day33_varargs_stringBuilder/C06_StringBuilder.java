...
public class C06_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println(sb1.reverse()); // .nide takkid ezirP attayaH  // tersine cevirir.

        System.out.println(sb1);
        System.out.println(sb1.reverse()); //Hayatta Prize dikkat edin.

        System.out.println(sb1.substring(3,5)); // at // stringe cevirdiginden deger atamasi yapmadi. immutable oldu.
        System.out.println(sb1); // Hayatta Prize dikkat edin.

        System.out.println(sb1.subSequence(3,5)); // at //  substring gibidir
        System.out.println(sb1); // Hayatta Prize dikkat edin.
