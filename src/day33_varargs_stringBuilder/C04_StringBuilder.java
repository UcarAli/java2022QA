...
public class C04_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println(sb1); // Ne guzel Java // StringBuilder mutable oldugundan sout icinde yapilan degisiklik kalici oldu , atamaya gerek kalmadi. list gibi
        ...
        System.out.println(sb1.deleteCharAt(5)); // guzelJava // bosluk karakrteri silindi
