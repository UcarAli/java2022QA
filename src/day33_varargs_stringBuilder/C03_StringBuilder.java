...
public class C03_StringBuilder {
    public static void main(String[] args) {
        ...
        sb1.append(3);
        System.out.println("sb1 = " + sb1); // sb1 = Java cok guzel3
        sb1.append(true);
        System.out.println("sb1 = " + sb1); // sb1 = Java cok guzel3true
        ...
        sb1.trimToSize(); // capacity i leng e esitledi. yani gereksiz ayrilan kapasiteyi almadi
        System.out.println("sb1.length() = " + sb1.length()); // 40
