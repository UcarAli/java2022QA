...
public class C05_StringBuilder {
    public static void main(String[] args) {
        ...
        // System.out.println(sb1.compareTo(str)); kabul etmiyor
        // string ile stringBulder compare yapilamaz cte verir


        // SB'da equals methodu String'deki == gibi calisir
        System.out.println(sb1.equals(sb2)); // false
        System.out.println(sb1.equals(sb1)); // true // equals ancak hersey ayni olurasa (ref dahil) true verir.

        System.out.println(sb1.equals(str)); // false

        // System.out.println(sb1==str);
        // farkli obje turleri oldugu icin java kiyas yapmaz
