...
public class C04_Set {
    public static void main(String[] args) {
        ...
        System.out.println("isimler = " + isimler); // [Aykut, Seckin, Ilker, Oguzhan]
        ...
        System.out.println("isimler = " + isimler); // [Aykut, Seckin, Cosmos, Oguzhan]
        System.out.println("logListesi = " + logListesi); // [Ilker]
