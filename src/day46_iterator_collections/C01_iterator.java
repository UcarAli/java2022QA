...
public class C01_iterator {
    public static void main(String[] args) {
        ...
        // Iterator itr =new Iterator(); bu sekilde obje olusturarak olmaz. cunku Iterator ler abstract oldugundan obje olusturamayiz. collection uyesi bir obje kullanmaliyiz.
        ...
        itr.remove(); // son durdugu indexi sildi. 7 silindi
        System.out.println(liste); // [5, 8, 6, 9]
        //itr.remove(); // en son remove yaptigimiz elementi sildi ve orda silinen elementte kaldi. o da silindiginden hata verir. next() ile bir sonraki elemente gecip onu silebiliriz.
