...
public class C02 extends C01{
    ...
    public void method2() {
        /*
            @Override notasyonu ile overridded method ile overriding method'u
            birbirine baglar
            Farkinda olmadan overriden method silinirse veya signature
            degistirilirse bu iliski bozulacagi icin Jaava CTE verir
