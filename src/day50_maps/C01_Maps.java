...
public class C01_Maps {
    public static void main(String[] args) {
        ...
        System.out.println("sinifKeySeti = " + sinifKeySeti);

        List<Integer > keyList  = new ArrayList<>();
        keyList.addAll(sinifKeySeti);
//        keyList.addAll(sinifListMap.keySet());
        ...
        System.out.println("sinifValueColl = " + sinifValueColl);

        List<String > sinifValueList  = new ArrayList<>();
        sinifValueList.addAll(sinifValueColl);
        System.out.println("sinifValueList = " + sinifValueList);
         ...
         */
        System.out.println(sinifValueList.size());
        ...
        for (int i = 0; i <keyList.size() ; i++) {
            System.out.printf("| %-10d |", keyList.get(i));
            for (int j = 0; j < innerArrayBoyut; j++) {
                System.out.printf(" %-10s %s",valueMDArr[i][j],"|");
            }
            System.out.println("");
        }
        System.out.printf("| %-30.49s |"," --------------------------------------------------");
